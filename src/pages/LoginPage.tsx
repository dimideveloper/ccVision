    ...
    <div className="min-h-screen w-full bg-[#ffffff] text-[#1d1d1f] flex flex-col selection:bg-yellow-100" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        >
          ...
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div className="flex justify-end">
              <button type="button" className="text-[14px] font-medium text-[#0066cc] hover:underline">
                Forgot password?
              </button>
            </div>

            <button className="w-full bg-[#1d1d1f] text-white py-4 rounded-xl font-semibold text-[17px] hover:bg-[#323235] transition-all active:scale-[0.98]">
              Continue
            </button>
          ...
          <p className="text-center text-[15px] font-medium text-[#86868b]">
            New to ccVision? <Link to="/register" className="text-[#0066cc] hover:underline">Create yours now.</Link>
          </p>
        </motion.div>
      </main>
      ...
      <footer className="p-8 text-center">
        <p className="text-[12px] text-[#86868b] max-w-sm mx-auto leading-relaxed">
          By logging in, you agree to our <a href="#" className="text-[#1d1d1f] hover:underline font-medium">Terms & Conditions</a> and acknowledge that you have read our <a href="#" className="text-[#1d1d1f] hover:underline font-medium">Privacy Policy</a>.
        </p>
      </footer>
    </div>
  );
